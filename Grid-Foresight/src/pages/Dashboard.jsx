...
function Dashboard() {
  ...
  const [totalPower, setTotalPower] = useState(
    calculateTotalPower(globalRoomDevices[COMPANIES[0]]),
  );
  ...
  return (
    <div className="dashboard-container">
      <header className="dashboard-header">
        <h1>
          Dashboard<span className="blink-cursor">_</span>
        </h1>
      </header>
      <div className="dashboard-content">
            ...
            <div className="panel-content">
              <div className="forecast-grid-2col">
                <div className="forecast-left-col">
                  ...
                  <div className="stat-card stat-horizontal">
                    <span className="stat-icon">
                      <Navigation size={18} color="#00f3ff" />
                    </span>
                    <span
                      className="stat-val"
                ...
                <div className="forecast-right-col">
                  <div className="stat-card stat-horizontal">
                    <span className="stat-icon">
                      <Thermometer size={18} color="#00f3ff" />
                    </span>
              ...
              <div className="gadget-grid">
                {gadgets.map((gadget) => (
                  <div
                    ...
                    onClick={() =>
                      navigate(
                        `/search?room=All%20Rooms&company=${encodeURIComponent(selectedCompany)}&device=${encodeURIComponent(gadget.label)}`,
                      )
                    }
        ...
        <div className="bottom-container">
          ...
          <div
            className="sub-container bottom-right glass-panel glow-purple"
            style={{ display: "flex", flexDirection: "column" }}
          >
            ...
            <div
              className="panel-content scrollable-list-container"
              ...
              <ul className="room-list scrollable-list">
                {rooms.map((room, index) => (
                  <li
                    ...
                    onClick={() =>
                      navigate(
                        `/search?room=${encodeURIComponent(room)}&company=${encodeURIComponent(selectedCompany)}`,
                      )
                    }
                  >
